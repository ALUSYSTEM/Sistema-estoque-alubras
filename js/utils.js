...
class Utils {
    ...
    static formatDate(date, includeTime = false) {
        ...
        if (!includeTime) {
            // Normalizar para evitar problemas de fuso horário em datas sem hora
    ...
    // Converter valor (string, Date, Timestamp) em Date fixando o horário em 12:00 para evitar ajustes de fuso

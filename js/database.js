...
class DatabaseManager {
    ...
    async getEstoque(filters = {}) {
        try {
            ...
            // OTIMIZAÇÃO: Buscar dados relacionados apenas se necessário (remover essa parte que faz consultas extras)
            // Comentada porque está causando lentidão desnecessária

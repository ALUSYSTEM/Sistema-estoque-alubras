...
class DashboardPage {
    ...
    setupRealtimeListeners() {
        ...
        // Listener para estoque (atualizar estatísticas relacionadas)
        const estoqueListener = databaseManager.onEstoqueChange(async (snapshot) => {
            // Recalcular estatísticas de estoque
            try {

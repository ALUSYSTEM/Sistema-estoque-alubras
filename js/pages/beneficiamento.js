                ...
                <tr>
                    ...
                    <td class="text-center">
                        <div class="btn-group" role="group">
                            ...
                            ${this.canEdit(ben) ? `
                            <button type="button" class="btn btn-outline-warning btn-sm edit-beneficiamento-btn" 
                                    data-beneficiamento-id="${ben.id}"
                                    title="Editar">
        ...
        document.addEventListener('click', (e) => {
            ...
            if (e.target.closest('.update-status-btn')) {
                ...
                if (beneficiamentoId) {
                    e.preventDefault();
                    e.stopPropagation();
                    this.updateStatusModal(beneficiamentoId);
                }
            }
        });
    }
                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group" role="group">
                            ...
                            <button class="btn btn-sm btn-outline-primary edit-beneficiamento-btn" 
                                    data-beneficiamento-id="${ben.id}" title="Editar">
                                <i class="fas fa-edit"></i>
                            </button>
                            <button class="btn btn-sm btn-outline-success update-status-btn" 
                                    data-beneficiamento-id="${ben.id}" title="Atualizar Status">
